...
- `DATA_ROOT/raw/protocols.csv`, `DATA_ROOT/raw/mandateMappings.csv` — session metadata and speaker ID crosswalk
...
**AfD entry dates** — `afd_entry.xlsx` (currently local-only under `data/raw/`, not yet migrated to `DATA_ROOT`) — manually curated, used as treatment variable.
